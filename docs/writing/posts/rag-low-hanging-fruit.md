...
!!! note "RAG Series"
    ...
    If you're looking to go deeper on RAG, start with the [RAG series index](./rag-series-index.md).
...
[RAG resources](./rag-series-index.md){ .md-button .md-button--primary }
